...
class MinidroneSensors:
    ...
    def update(self, name, value, sensor_enum):
        ...
        elif (name == "DronePosition_posx"): #added
            self.posx = value
        elif (name == "DronePosition_posy"): #added
            self.posy = value
        elif (name == "DronePosition_posz"): #added
            self.posz = value
        elif (name == "DronePosition_psi"): #added
            self.psi = value
        elif (name == "DronePosition_ts"): #added
            self.ts = value
        else:
